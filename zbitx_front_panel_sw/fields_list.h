...
struct field main_list[] = {
  ...
  {FIELD_SMETER, 243, 3, 189, 15, TFT_BLACK, "METERS", "0", "0/10000/1"},
  ...
  {FIELD_KEY, 0, 280, 72, 40,  TFT_BLACK, "ABC", "abc"},
  {FIELD_KEY, 72, 280, 60, 40,  TFT_BLACK, "Start", "Start"},
  {FIELD_KEY, 132, 280, 60, 40,  TFT_BLACK, "Stop", "Stop"},
  {FIELD_KEY, 192, 280, 48, 40,  TFT_BLACK, "/", "\\"},
  {FIELD_KEY, 240, 280, 72, 40,  TFT_BLACK, "space", "space"},
  {FIELD_KEY, 312, 280, 48, 40,  TFT_BLACK, ".", ":"},
  {FIELD_KEY, 360, 280, 48, 40,  TFT_BLACK, "?", ","},
  {FIELD_KEY, 408, 280, 72, 40,  TFT_BLACK, "[x]", "[x]"},  
  ...
  /* wiersz 3 menu - y=144, miejsce na dodatkowe funkcje */
  {FIELD_BUTTON, 24, 144, 48, 48,  TFT_DARKGREY, "WIFI", ""},
	/* settings */
  ...
  /* WiFi settings - dialog layout (480x320, title bar 30px, line y=31) */
  /* Row 1 y=40: IP status full width */
  {FIELD_STATIC,    8,   38, 464, 20, TFT_BLACK,    "WIFI_IP",      "IP: ---",        ""},
  /* Row 2 y=62: SSID label + field + SCAN button */
  {FIELD_STATIC,    8,   62,  44, 20, TFT_BLACK,    "WF_SSID_LBL",  "SSID:",          ""},
  {FIELD_TEXT,     56,   58, 320, 24, TFT_BLACK,    "WIFI_SSID",    "",               "0/32"},
  {FIELD_SELECTION,  384,   54,  88, 32, TFT_DARKGREY, "WIFI_SCAN",    "",           ""},
  /* Row 3 y=90: password label + field + show checkbox */
  {FIELD_STATIC,    8,   92,  44, 20, TFT_BLACK,    "WF_PASS_LBL",  "PASS:",          ""},
  {FIELD_TEXT,     56,   88, 248, 24, TFT_BLACK,    "WIFI_PASS",    "",               "0/32"},
  {FIELD_SELECTION,312,   88, 160, 24, TFT_DARKGREY,"WIFI_SHOWPASS","0",              "0/1"},
  /* Row 4 y=118: action buttons */
  {FIELD_SELECTION,    8,  118,  88, 36, TFT_GREEN,    "WIFI_SAVE",    "",           ""},
  {FIELD_SELECTION,  104,  118,  88, 36, TFT_RED,      "WIFI_OFF",     "",            ""},
  {FIELD_BUTTON,     384,  118,  88, 36, TFT_DARKGREY, "WIFI_CLOSE",   "",            ""},
  /* Row 5 y=162..280: scan results list */
  {FIELD_WIFI_LIST, 8,  160, 464,120, TFT_BLACK,    "WIFI_LIST",    "",               ""},
  /* Status bar bottom */
  {FIELD_STATIC,    8,  286, 464, 20, TFT_BLACK,    "WIFI_STATUS",  "Not connected",  ""},
